...
func main() {
	...
	// Any argument typed AFTER the you list your arguments get passed into the os.Args array with the name of the program at the first index		// Any argument typed AFTER the you list your arguments get passed into the os.Args array with the name of the program at the first index
	var fileName string	
	if len(os.Args) > 1 {	
		fileName = os.Args[1]	
	} else {
		fmt.Println("I'm sorry, your file is missing. Try running `go run <current_file> <file_name>` for better results")			fmt.Println("I'm sorry, your file is missing. Try running `go run <current_file> <file_name>` for better results")
		os.Exit(1)
	}
